...
public class ShopUI extends JPanel
{
	...
	public ShopUI(SystemManager systemManager) 
	{
		...
		l_money = new JLabel("Money: Au 99999");
		...
		l_itemInfo.setBounds(431, 216, 445, 121);
		add(l_itemInfo);
		...
		l_basePower.setBounds(557, 395, 65, 30);
		add(l_basePower);
		...
		b_downPower.setBounds(513, 395, 44, 30);
		add(b_downPower);
		...
		b_upPower.setBounds(622, 395, 44, 30);
		add(b_upPower);
		...
		l_addedPower.setBounds(668, 395, 79, 30);
		add(l_addedPower);
